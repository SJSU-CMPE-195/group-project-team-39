...
# ==============================================================================
TARGET_FPS     = 60        # camera tops out at 60 in side-by-side mode
...
# ==============================================================================
# All in current OUTPUT pixel space (510x400 portrait after rotation).
MALLET_ORIGIN_PX = (197, 433)         # mallet 0,0 position in pixels
CRIT_TL_PX       = (97  , 343)         # critical zone top-left
CRIT_BR_PX       = (295, 473)         # critical zone bottom-right
...
def main():
    ...
    while True:
        ...
        if not window_sized and not HEADLESS:
        ...
        # FPS counter (tracked in all modes)
        frame_count += 1
